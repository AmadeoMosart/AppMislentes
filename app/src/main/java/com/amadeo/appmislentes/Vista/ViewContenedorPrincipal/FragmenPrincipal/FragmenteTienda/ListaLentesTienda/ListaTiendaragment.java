package com.amadeo.appmislentes.Vista.ViewContenedorPrincipal.FragmenPrincipal.FragmenteTienda.ListaLentesTienda;
...
public class ListaTiendaragment extends Fragment implements View.OnClickListener {
    ...
    private void showDialog() {
        ...
        Animation animation1= AnimationUtils.loadAnimation(getContext(),R.anim.desplazamiento_arriba);

        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
        LayoutInflater inflater = getLayoutInflater();
        View view = inflater.inflate(R.layout.dialog_tienda, null);
        builder.setView(view);
        final AlertDialog dialog = builder.create();
        dialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        view.setAnimation(animation1);

        Button btnOkey = view.findViewById(R.id.btnOkey);
